...
public class Alphabet {
    ...
    public Alphabet(String alpha) {
        ...
        alphabet = alpha.toCharArray();///an array of chars in alpha
        R = alpha.length();
    ...
    public int[] toIndices(String s) {
        ...
        for (int i = 0; i < source.length; i++) {
            StdOut.print(source[i] + " ");
            target[i] = toIndex(source[i]);
            StdOut.println(target[i]);
        }
        return target;
    }
...
//        StdOut.println(decoded3);
        ...
        int[] encode4 = Alphabet.UNICODE16.toIndices("Không khó");
        String decoded4 = Alphabet.UNICODE16.toChars(encode4);
        StdOut.println(decoded4);
    }
}
