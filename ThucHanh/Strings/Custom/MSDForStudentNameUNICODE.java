...
public class MSDForStudentNameUNICODE {
    ...
    public static void main(String[] args) throws IOException {
        System.setIn(new FileInputStream(new File("Custom/studentUNICODE16.csv")));
