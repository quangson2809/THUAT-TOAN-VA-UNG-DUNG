/******************************************************************************
 *  Compilation:  javac LZWOutFile.java
 *  Execution:    java LZWOutFile - < input.txt   (compress)
 *  Execution:    java LZWOutFile + < input.txt   (expand)
 ...
 *
 *  Compress or expand binary input from standard input using LZWOutFile.
 *
...
/**
 *  The {@code LZWOutFile} class provides static methods for compressing
 *  and expanding a binary input using LZWOutFile compression over the 8-bit extended
...
public class LZWOutFile {
     ...
     * them using LZWOutFile compression with 12-bit codewords; and writes the results
     * to standard output.
     */
    ...
    /**
     * Reads a sequence of bit encoded using LZWOutFile compression with
