...
public class LongestRepeatedSubstringCodeCpp {
    ...
    public static String lrs(String text) {
        ...
        for (int i = 1; i < n; i++) {
            ...
            if (length > lrs.length()) {
                ...
                lrs = text.substring(sa.index(i), sa.index(i) + length);///cắt chuỗi theo index trong text của suffix
            }
        }
        return lrs;
    }
    ...
    public static void main(String[] args) throws IOException {
        System.setIn(new FileInputStream(new File("C:\\Users\\Admin\\OneDrive\\Desktop\\UTC\\studying\\CTDL_GT\\vector\\lophoc.cpp")));
