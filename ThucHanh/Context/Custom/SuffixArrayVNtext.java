 ...
 */
public class SuffixArrayVNtext {
     ...
     */
    public SuffixArrayVNtext(String text) {
        int n = text.length();
    ...
    private static class Suffix implements Comparable<Suffix> {
        private final String text;///chuỗi suffix
        private final int index;/// vị trí tiền tố đầu tiên của suffix trong chuỗi gốc

        private Suffix(String text, int index) {
            this.text = text;/// tránh tốn bộ nhớ đẻ cấp phát sub trươc khi gán thì text trỏ đến chuỗi gốc
            this.index = index;
        }
        private int length() {
     ...
     */
    public int lcp(int i) {/// tìm số tieenf tố chung của suffix hiện tại và suffix trước nó trong bảng suffix đã sắp xếp
     ...
     */
    public int rank(String query) {///tìm vị trí c thẻ có của query trong mảng suffix, nếu có query trong mảng thì trả về vị trí
                                    /// chính xác của nó, nếu không thì trả về vị trí của nó khi đc chèn vào trong mảng
    ...
    public static void main(String[] args) throws IOException{
        System.setIn(new FileInputStream(new File("Custom/VNtext.txt")));
        ...
        StdOut.print(suffix.rank("không"));
    }
